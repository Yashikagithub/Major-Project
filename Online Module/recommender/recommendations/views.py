...
def course_detail(request, course_id):
    try:
        ...
        return render(request, 'course_detail.html', {'course': course})  # Render course details page
    except Course.DoesNotExist:
        return render(request, '404.html', {'error': 'Course not found'})  # Optional: Handle 404
